...
# This script removes trailing whitespaces from all files in the provided directory.
# Use: remove_trailing_whitespaces.sh [--check] directory_path
#        --check: Check for trailing whitespaces without actually modifying the files.
#        directory_path: The path to the directory to be processed. If not provided, raises an error.
# Executable: ./remove_trailing_whitespaces.sh [--check] path/to/directory
